...
<table border="0" align="center" width="40%" style="margin-left: 100px;">
	...
	<tr>
		<td>客户性别</td>
		<td>
			<input type="radio" name="gender" value="男" id="male" <c:if test="${requestScope.customer.gender eq '男'}">checked="checked"</c:if>/>
			<label for="male">男</label>
			<input type="radio" name="gender" value="女" id="female" <c:if test="${requestScope.customer.gender eq '女'}">checked="checked"</c:if>/>
	...
	<tr>
		<td>手机</td>
		<td>
			<input type="text" name="cellphone" value="${requestScope.customer.cellphone}"/>
		</td>
		<td>
